...
Home Assistant support for the [Advanced Operational Aviation Weather System (AOAWS)](https://aoaws.anws.gov.tw/). [The readme in Traditional Chinese](https://github.com/bluefoxlee/TwANWS/blob/master/README_zh-tw.md).
...
1. With GUI. Configuration > Integration > Add Integration > Advanced Operational Aviation Weather System (AOAWS)
...
AOAWS is operated by Air Navigation and Weather Services, CAA, MOTC (ANWS).
